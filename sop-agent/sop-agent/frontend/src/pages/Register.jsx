    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-base px-4">
      ...
      <div className="relative w-full max-w-sm animate-slideUp">
        <div className="mb-8 flex flex-col items-center text-center">
          <Logo size={48} />
          <h1 className="mt-4 font-display text-xl font-semibold text-ink">Create your account</h1>
          <p className="mt-1 text-sm text-ink-muted">Start asking questions about your SOPs</p>
        </div>
        ...
        <p className="mt-5 text-center text-sm text-ink-muted">
          ...
          <Link to="/login" className="font-medium text-accent-400 hover:text-accent-200">
            Log in
          </Link>
        </p>
      </div>
